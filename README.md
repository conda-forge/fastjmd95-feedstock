About fastjmd95-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fastjmd95-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10147&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fastjmd95-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fastjmd95` can be installed with `conda`:
...
```
mamba install fastjmd95
```

It is possible to list all of the versions of `fastjmd95` available on your platform with `conda`:
...
```
mamba search fastjmd95 --channel conda-forge
```
...
mamba repoquery search fastjmd95 --channel conda-forge

# List packages depending on `fastjmd95`:
mamba repoquery whoneeds fastjmd95 --channel conda-forge

# List dependencies of `fastjmd95`:
mamba repoquery depends fastjmd95 --channel conda-forge
```
